...
public class ForwardTestCases {
	...
	public void noNecesitaReparacionTest() {
		...
		FactHandle reparacionDir = sessionStatefull.insert(reparacion);
		sessionStatefull.fireAllRules();

		reparacion = (Reparacion) sessionStatefull.getObject(reparacionDir);
	...
	public void cargarBateriaTest() {
		...
		sessionStatefull.insert(reparacion);
		sessionStatefull.fireAllRules();
